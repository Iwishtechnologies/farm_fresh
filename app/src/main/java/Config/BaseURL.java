...
public class BaseURL {
    ...
    public static String BASE_URL = "http://173.212.226.143/farm_fresh/";  //     http://onhome.iwishtechnologies.com/
    ...
    //public static String OLD_PRICE = BASE_URL + "index.php/api/get_all_deal_product";
    ...
    public static String CHECKER_URL = BASE_URL + "index.php/api/loginchecker";
    ...
    public static String FORGETPASSWORD = BASE_URL + "index.php/api/forgetpassword";
