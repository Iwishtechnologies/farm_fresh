...
SharedPreferences preferences;
    ...
    String store_id;
String language;
    private int dlv_charge;
    private int desired_string;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bundle arguments = getArguments();
         deli_charges = arguments.getInt("dilvery_charges");
        ...
        total_charge = Integer.parseInt(db_cart.getTotalAmount())+deli_charges;
        tv_total.setText(total_charge+"");
