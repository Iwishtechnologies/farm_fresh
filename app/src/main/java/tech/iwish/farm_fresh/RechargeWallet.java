...
import tech.iwish.farm_fresh.networkconnectivity.NetworkConnection;
import tech.iwish.farm_fresh.networkconnectivity.NetworkError;
...
public class RechargeWallet extends AppCompatActivity implements PaymentResultListener {
    ...
    private void Recharge_wallet() {
        ...
        if (NetworkConnection.connectionChecking(this)) {
            ...
            StringRequest postReq = new StringRequest(Request.Method.POST, BaseURL.BASE_URL+"index.php/api/" +
                    "recharge_wallet",
